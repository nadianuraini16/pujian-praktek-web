...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: white;">
 ...
 while ($tampil = mysqli_fetch_array($ambildata)){
    ...
    <td><a href='?kode=$tampil[kode]'>hapus</a></td>
    <td><a href='ubahmapel.php?kode=$tampil[kode]'>ubah</a></td>
...
if(isset($_GET['kode'])) {
    ...
    mysqli_query($koneksi, "delete from mapel where kode='$_GET[kode]'");
...
?>
    ...
    <br>
        <a class="btn btn-outline-light"  href="tambahmapel.php" role="button"style="margin-left: 500px; " >Tambah data</a>
</body>
